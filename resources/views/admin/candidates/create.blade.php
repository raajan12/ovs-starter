        ...
        <div class="col p-4">
            <div class="card ">
                <div class="card-header">
                    <h3 class="card-title text-dark">Create Candidate</h3>
                </div>
                <div class="card-body">
                    <form class="form" action="{{ route('admin.candidates.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group text" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="description" class="form-control datetimepicker-input">
                            </div>
                            @error('description')
                                <div class=" text-danger text-sm">{{ $message }}</div>
                            @enderror
